...
const CLIENT_PORTFOLIO = [
  ...
  { id: 'p4', name: 'Guarajtee Clinic Lab', description: 'Delivered dependable website support, enabling efficient access to clinic information and services.', initials: 'GC', logo: '/Clients/GuarajteeClininLab.png' },
  ...
  { id: 'p7', name: 'Dlight', description: 'Developed a product showcase website with continuous support, enabling effective product presentation and smooth operations.', initials: 'DL', logo: null },
